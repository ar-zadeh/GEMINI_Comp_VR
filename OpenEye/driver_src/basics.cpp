...
const char *const k_pch_Sample_TcpHost_String = "tcpHost";
const char *const k_pch_Sample_TcpPort_Int32 = "tcpPort";
const char *const k_pch_Sample_TcpEnabled_Bool = "tcpEnabled";
const char *const k_pch_Sample_VisionEnabled_Bool = "visionEnabled";
