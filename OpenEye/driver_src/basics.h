...
extern const char *const k_pch_Sample_TcpHost_String;
extern const char *const k_pch_Sample_TcpPort_Int32;
extern const char *const k_pch_Sample_TcpEnabled_Bool;
extern const char *const k_pch_Sample_VisionEnabled_Bool;
